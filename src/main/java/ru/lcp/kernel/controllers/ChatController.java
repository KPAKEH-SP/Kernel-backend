...
public class ChatController {
    ...
    public ResponseEntity<?> changeChatName(@RequestHeader("X-Token") String token, @RequestBody ChangeChatNameRequest chatId) {
        return chatService.changeChatName(token, chatId);
    }
